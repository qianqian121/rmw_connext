...
static message_type_support_callbacks_t __callbacks = {
  "@(pkg)",  // package_name
  "@(msg)",  // message_name
  @(spec.base_type.pkg_name)__@(spec.msg_name)__register_type,  // register_type
  @(spec.base_type.pkg_name)__@(spec.msg_name)__publish,  // publish
  @(spec.base_type.pkg_name)__@(spec.msg_name)__take, // take
  @(spec.base_type.pkg_name)__@(spec.msg_name)__convert_ros_to_dds,  // convert_ros_to_dds
  @(spec.base_type.pkg_name)__@(spec.msg_name)__convert_dds_to_ros,  // convert_dds_to_ros
};
